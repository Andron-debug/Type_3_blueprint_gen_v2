...
settings = {"cxpb": 0.8, "mutpb": 0.15, "ngen": 20, "gen_size": 1000}
bp = Blueprint("Схема 1")
xp1 = Connector("XP1", bp)
xp1_con = [Contact(i) for i in range(8)]
xp1_sh1 = GroupOfContact("SH1", xp1, [xp1_con[0], xp1_con[1]])
xp1_con[2].parent = xp1
xp1_sh1.addConnection(xp1_con[2])
xp1_sh2 = GroupOfContact("SH2", xp1, [xp1_con[3], xp1_con[4]])
xp1_sh3 = GroupOfContact("SH3", xp1, [xp1_con[5], xp1_con[6]])
